    ...
    def run(self):
        ...
        while True:
            ...
            if (int(arguments[0]) - 1 == 0):
                self.player_1.updateState(int(arguments[1]), arguments[2])
            elif (int(arguments[0]) - 1 == 1):
                self.player_2.updateState(int(arguments[1]), arguments[2])

            print("player GestureID: ", self.player_2.gestureID)
            print("player GestureID: ", int(self.player_2.gestureID) == GestureID.Shoot.value)
